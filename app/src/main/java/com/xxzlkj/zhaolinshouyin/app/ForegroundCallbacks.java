...
public class ForegroundCallbacks implements
		...
		if (wasBackground) {
			...
			for (Listener l : listeners) {
				try {
					...
					Log.e("ForegroundCallbacks", "Listener threw exception!",
							exc);
				}
			}
		} else {
			Log.e("ForegroundCallbacks", "still foreground");
		}
	}
				...
				if (foreground && paused) {
					...
					for (Listener l : listeners) {
						try {
							...
							Log.e("ForegroundCallbacks",
									"Listener threw exception!", exc);
						}
					}
				} else {
					Log.e("ForegroundCallbacks", "still foreground");
